...
If you edit and save the servlet file then refresh the browser you will see the changes are not picked up
...
"reload" re-compiles the scala project file.

If you edit and save the servlet then refresh you browser then the changes should be immediately visible.
